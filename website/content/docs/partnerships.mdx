...
- Contributing to Nomad [guidelines](https://github.com/hernad/nomad/tree/main/contributing)
- [Nomad Developer Community Forum](https://groups.google.com/g/nomad-tool)
- [Nomad's source code](https://github.com/hernad/nomad)
...
- [Template for writing a device plugin](https://github.com/hernad/nomad-skeleton-device-plugin)
- [Example of a device plugin](https://github.com/hernad/nomad/tree/main/devices/gpu/nvidia)
...
For task, device, storage, and autoscaling plugins, please submit a GitHub pull request (PR) against the [Nomad project](https://github.com/hernad/nomad). In some cases the vendor may need to provide HashiCorp with a permanent test account so that the integration can be verified on an ongoing basis.
