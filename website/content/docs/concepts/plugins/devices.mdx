...
GPU plugin](https://github.com/hernad/nomad-device-nvidia).
...
[deviceplugin]: https://github.com/hernad/nomad/blob/v0.9.0/plugins/device/device.go#L20-L33
[baseplugin]: /nomad/docs/concepts/plugins/base
[skeletonproject]: https://github.com/hernad/nomad-skeleton-device-plugin
[fingerprintresponse]: https://github.com/hernad/nomad/blob/v0.9.0/plugins/device/device.go#L37-L43
[fingerprintfn]: https://github.com/hernad/nomad-skeleton-device-plugin/blob/v0.1.0/device/device.go#L159-L165
[statsfn]: https://github.com/hernad/nomad-skeleton-device-plugin/blob/v0.1.0/device/device.go#L169-L176
[reservefn]: https://github.com/hernad/nomad-skeleton-device-plugin/blob/v0.1.0/device/device.go#L189-L245
[dimensioned]: https://github.com/hernad/nomad/blob/v0.9.0/plugins/shared/structs/stats.go#L33-L34
