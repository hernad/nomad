...
[ct_nomad_service_fn]: https://github.com/hernad/consul-template/blob/main/docs/templating-language.md#nomadservice
[ct_service_fn]: https://github.com/hernad/consul-template/blob/main/docs/templating-language.md#service
