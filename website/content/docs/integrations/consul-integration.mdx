...
that utilizes a Consul ecosystem tool called [Consul Template](https://github.com/hernad/consul-template). This mechanism creates a convenient way to ship configuration files
