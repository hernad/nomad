...
- `VaultGrace` - [Deprecated](https://github.com/hernad/consul-template/issues/1268)
...
can be queried by [external autoscalers](https://github.com/hernad/nomad-autoscaler).
...
- `Policy` - An optional JSON block. This is opaque to Nomad; see the documentation for the external
  autoscaler (e.g., [nomad-autoscaler](https://github.com/hernad/nomad-autoscaler)).
