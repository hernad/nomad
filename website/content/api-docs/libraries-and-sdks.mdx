...
- [`api`](https://github.com/hernad/nomad/tree/main/api) - Official Golang
  client for the Nomad HTTP API ([GoDoc](https://pkg.go.dev/github.com/hernad/nomad/api))
...
- [`nomad-java-sdk`](https://github.com/hernad/nomad-java-sdk) - Official
  Java client for the Nomad HTTP API.

- [`nomad-scala-sdk`](https://github.com/hernad/nomad-scala-sdk) - Official
  Scala client for the Nomad HTTP API.

- [`nomad-ruby`](https://github.com/hernad/nomad-ruby) - Ruby client
  for the Nomad HTTP API.
...
_Want to see your library here? [Submit a Pull Request](https://github.com/hernad/nomad)._
