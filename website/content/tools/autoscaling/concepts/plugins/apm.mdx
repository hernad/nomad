...
[`prometheus` plugin](https://github.com/hernad/nomad-autoscaler/tree/main/plugins/builtin/apm/prometheus).
...
[apm_plugin]: https://github.com/hernad/nomad-autoscaler/blob/v0.3.0/plugins/apm/apm.go#L11
[base_plugin]: /nomad/tools/autoscaling/internals/plugins/base
[noop_plugin]: https://github.com/hernad/nomad-autoscaler/tree/v0.3.0/plugins/test/noop-apm
