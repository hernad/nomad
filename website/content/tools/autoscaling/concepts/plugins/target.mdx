...
[nomad_group_count_plugin]: https://github.com/hernad/nomad-autoscaler/tree/v0.3.0/plugins/builtin/target/nomad
[target_plugin]: https://github.com/hernad/nomad-autoscaler/blob/v0.3.0/plugins/target/target.go#L12
[base_plugin]: /nomad/tools/autoscaling/internals/plugins/base
[noop_plugin]: https://github.com/hernad/nomad-autoscaler/tree/v0.3.0/plugins/test/noop-target
[scaling_action_sdk]: https://github.com/hernad/nomad-autoscaler/blob/v0.3.0/sdk/strategy.go#L25
[policy_target]: /nomad/tools/autoscaling/policy#target
[target_status_sdk]: https://github.com/hernad/nomad-autoscaler/blob/v0.3.0/sdk/target.go#L6
