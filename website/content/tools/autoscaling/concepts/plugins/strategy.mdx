...
evaluation. The `eval` argument contains [information](https://github.com/hernad/nomad-autoscaler/blob/v0.3.0/sdk/eval_oss.go#L8)
...
[strategy_plugin]: https://github.com/hernad/nomad-autoscaler/blob/v0.3.0/plugins/strategy/strategy.go#L11
[base_plugin]: /nomad/tools/autoscaling/internals/plugins/base
[noop_plugin]: https://github.com/hernad/nomad-autoscaler/tree/v0.3.0/plugins/test/noop-strategy
[target_value]: https://github.com/hernad/nomad-autoscaler/tree/v0.3.0/plugins/builtin/strategy/target-value
