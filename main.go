...
import (
	...
	_ "github.com/hernad/nomad/client/allocrunner/taskrunner/getter"
	_ "github.com/hernad/nomad/client/logmon"
	_ "github.com/hernad/nomad/drivers/docker/docklog"
	_ "github.com/hernad/nomad/drivers/shared/executor"

	// Don't move any other code imports above the import block above!
	"github.com/hernad/nomad/command"
